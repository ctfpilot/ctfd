...
class ServerConfig(object):
    ...
    CACHE_REDIS_CLUSTER: str = empty_str_cast(config_ini["server"]["CACHE_REDIS_CLUSTER"])
    ...
    if CACHE_REDIS_CLUSTER:
        CACHE_TYPE: str = "RedisClusterCache"
    elif CACHE_REDIS_URL:
    ...
    print(f"Using cache type: {CACHE_TYPE}")
    print(f"Using Redis URL: {CACHE_REDIS_URL} (if applicable)")
    print(f"Using Redis Cluster: {CACHE_REDIS_CLUSTER} (if applicable)")
