...
> [!IMPORTANT]
> This theme is a customized version of the CTFd core theme, customized to work withe the [CTFd kube-ctf Plugin](https://github.com/ctfpilot/ctfd-kubectf-plugin).
>
> In the `challenge.html` file, the following block has been added after connection information, in order for the plugin to work:
>
> ```html
> {% block kubectf_info %}
> {% endblock %}
> ```
>
> The rest of this README originates from CTFd's core theme.

> [!NOTE]
> This theme is automatically built in the [CTFd Dockerfile](../../Dockerfile), no additional steps are required to use it.
